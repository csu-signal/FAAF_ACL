...
from faaf_trainer import FAAFTrainer  # Import FAAF trainer

@dataclass
class TrainingArguments:
   """Arguments for FAAF training"""
   model_name: str = "sft_trained_weights" # add your SFT model lora weights
   output_dir: str = "faaf_outputs"
   data_path: str = "data"
...
def main():
   ...
   loss_types = {
       'faaf': 5e-7,
       'faaf_not_conditioned': 5e-7, 
       'faaf_first_part_only': 5e-7
   }
   ...
   # Save logs
   with open('faaf_logs/experiment_logs.pkl', 'wb') as f:
