...
class FAAFTrainer(DPOTrainer):
    ...
    def __init__(
        ...
        loss_type: Literal["sigmoid", "hinge", "ipo","faaf",  "faaf_not_conditioned", "faaf_first_part_only", "aot", "aot_pair"] = "faaf",
        ...
        #         )
        #         print("Train dataset tokenized in FAAFTrainer subclass", self.train_dataset )
        ...
        #             writer_batch_size=10
        #         )
        #         print("Eval dataset tokenized in FAAFTrainer subclass", self.eval_dataset )
    ...
    def faaf_loss(
        ...
        """Compute the FAAF loss combining conditional and unconditioned policy ratios for preference learning. Adapted from DPO loss in DPO trainer
        ...
        Returns:
            ...
            - losses: FAAF loss combining conditional and unconditioned policy differences
        ...
        if self.f_divergence_type == FDivergenceType.ALPHA_DIVERGENCE.value:
            ...
            # get the direct logits for the faaf model
            friction_only_logits = pi_friction_logratios - ref_friction_logratios #second reward term in faaf loss objective
        ...
        elif self.loss_type == "faaf":
            print("getting loss FAAF")
            # eqn (17) of the paper where beta is the regularization parameter for the FAAF loss, denoted by beta in the paper.
            # losses = (logits - 1 / ( * self.beta)) ** 2
            losses = (self.beta*(logits + friction_only_logits) - 1)** 2

            elif self.loss_type == "faaf_not_conditioned":
            print("getting loss FAAF")
            # eqn (17) of the paper where beta is the regularization parameter for the FAAF loss, denoted by beta in the paper.
            # losses = (logits - 1 / ( * self.beta)) ** 2
            losses = (self.beta*(friction_only_logits) - 1)** 2

        elif self.loss_type == "faaf_first_part_only":
            print("getting loss FAAF")
            # eqn (17) of the paper where beta is the regularization parameter for the FAAF loss, denoted by beta in the paper.
            # losses = (logits - 1 / ( * self.beta)) ** 2
    ...
    def concatenated_forward(
        ...
        if self.loss_type == "ipo" or self.loss_type == "faaf" :
    ...
    def get_batch_loss_metrics(
        ...
        losses, chosen_rewards, rejected_rewards, chosen_friction_rewards, rejected_friction_rewards = self.faaf_loss(
            policy_chosen_logps,
            policy_rejected_logps,
            reference_chosen_logps,
            reference_rejected_logps,
